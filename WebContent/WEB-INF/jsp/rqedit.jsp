...
<body>
 ...
 <b>Edit User Details </b>
  ...
  <div>
   <form:form method="post" action="rqupdate" modelAttribute="user">
    <table>
   
     <tr>
      <td> Code :</td>
      <td><form:input path="custCode"
        value="${map.user.custCode}" />
      </td>
     </tr>
     ...
     <tr>
      ...
      <td><form:input path="custAddr1"
        value="${map.user.custAddr1}" />
      </td>
     </tr>
      ...
      <td><form:input path="custAddr2"
        value="${map.user.custAddr2}" />
      </td>
     </tr>
     ...
     <tr>
      <td> </td>
      <td><input type="submit" value="Request Edit" />
      </td>
     </tr>
    </table>
